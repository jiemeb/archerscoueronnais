...
$arrayValueFixe  = array ("categories", "civilite", "nom", "prenom","licence","arcType","email1","email2","telephone1","telephone2","dateNaissance","nationalite","adresse","cp","commune","dossier","certificat", "debutant" ,"chequeKit"  ,"chequeCotisation","groupe" ) ;
// Valeur a éditer
$arrayValue= array();
